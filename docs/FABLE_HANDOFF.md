...
Keep phase 1 focused on personal schedules and tasks. Automatic iCalendar feeds, subtasks, recurring tasks, priorities, notifications, reminders, member browsing, verification workflows, friends, sharing and voting are deferred. Google email verification is authentication and does not establish school verification.
