...
export const FAQ: ReadonlyArray<{ q: string; a: string }> = [
  ...
  { q: 'Who can message me?', a: `Only friends can send you private messages, and only a friend can add you to a group (up to ${CHAT.groupMaxMembers} people; the person who made it adds and removes members, and anyone can leave). Removing a friend or blocking closes the private chat for both of you. The global chat is different: everyone on Quasar can post there, and you can mute it.` },
  { q: 'What is the global chat?', a: 'One room under Groups that everyone on Quasar can read and post in. Swearing is fine, slurs are censored to asterisks in every chat, and the owner can edit or remove any message in the room, with the reason shown in its place.' },
  { q: 'Can people see when I’ve read a message, or that I’m typing?', a: 'In private chats and groups, yes: your friends see “Delivered” once your device has the message, “Read” once you have scrolled to it, and “typing…” while you write. The global chat shows neither.' },
  { q: 'How do I format a message?', a: 'Type **bold**, _italic_, ~~struck~~ or `code`, start lines with - for a list or > for a quote, or tap the formatting button next to the message box. Links only become clickable when they start with https://.' },
  { q: 'How do I change my profile photo?', a: 'Open Account from your avatar. You can upload a photo (it is cropped square and shrunk before it leaves your device), use your Google photo, or show just your initial. Only people signed in to Quasar see it.' },
  { q: 'Support paused my messaging, or removed me from my school. What now?', a: 'You always see the reason: under the pause notice in Messages, or on the school step if you were removed. Both have an Appeal button. Support reads every appeal and answers by lifting the pause or removal, or keeping it. If you were removed, you can still join a different school.' },
  { q: 'Can support read my messages?', a: `Your private chats, only through a report. A report shares up to ${CHAT.evidence} messages from that one chat with support, and nobody at Quasar browses private chats. The global chat is public: the owner can read, edit and remove any post there.` },
